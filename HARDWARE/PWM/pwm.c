...
{
	TIM_SetCompare1(TIM10,all_out.back_thr);
	TIM_SetCompare1(TIM11,all_out.head_thr);
	TIM_SetCompare1(TIM9,all_out.left_thr);
	TIM_SetCompare2(TIM9,all_out.right_thr);
}
